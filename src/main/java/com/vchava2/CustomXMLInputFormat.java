...
public class CustomXMLInputFormat extends TextInputFormat {
    ...
    public static final String STARTING_TAGS = "xmlinput.start";
    public static final String ENDING_TAGS = "xmlinput.end";
    ...
    public static class XmlRecordReader extends RecordReader<LongWritable, Text> {
        ...
        private String[] startingTags;
        private String[] endingTags;
        ...
        public XmlRecordReader(FileSplit split, Configuration conf) throws IOException {
            startingTags = conf.get(STARTING_TAGS).split(",");
            endingTags = conf.get(ENDING_TAGS).split(",");
        ...
        private boolean next(LongWritable key, Text value) throws IOException {
            ...
            if (fsin.getPos() < end && readUntilStartTag2(startingTags, false)) {
                try {
                    buffer.write(startingTags[tag].getBytes(StandardCharsets.UTF_8));
                    if (readUntilMatch(endingTags[tag].getBytes(StandardCharsets.UTF_8), true)) {
                        key.set(fsin.getPos());
        ...
        private boolean readUntilStartTag2(String[] tags, boolean withinBlock) throws IOException {
            ...
            while (true) {
                ...
                for (int j=0; j<tags.length; j++) {
                    ...
                    byte[] currentTagBytes = currentTag.getBytes("UTF-8");
